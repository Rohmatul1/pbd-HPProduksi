	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Detail Tenaga Kerja Langsung</h3></center>
					<form  action="tkl_i_res.php" method="post">
					<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Kode Tenaga Kerja Langsung</label>
								<input type="text" class="form-control"  name="IdTenagaKerjaLangsung" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Biaya Tenaga Kerja Langsung</label>
						...
						<div class="col-md-6">
							<div class="form-group label-floating">
								...
								<input type="number" class="form-control"  name="JamKerja" required>
							</div>
						</div>
