	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Input Bahan Baku</h3></center>
					<form  action="bb_i_res.php" method="post">
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Kode Bahan Baku</label>
								<input type="text" class="form-control" name="kd_bb" >
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Nama Bahan Baku</label>
								<input type="text" class="form-control"  name="nm_bb" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
						...
						<div class="col-md-6">
							<div class="form-group label-floating">
								...
								<input type="number" class="form-control"  name="hrg_satuan" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
