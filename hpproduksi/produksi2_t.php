	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Laporan Harga Pokok Produksi</h3></center>
				<?php  
                    $sql_cek="select produksi2.kd_pro2, produksi1.kd_pro1, produksi2.totalHPProduksi
												FROM produksi2
												JOIN produksi1 ON
												produksi2.kd_pro1 = produksi1.kd_pro1 ORDER BY kd_pro2 asc";
                ...
                ?>
                                    <table class="table table-hover">
                                        <thead class="text-primary">
                                            <th>No</th>
                                            <th>Kode Harga Pokok Produksi</th>
                                    ...
                                    ?>
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $data['kd_pro2']; ?></td>
                                                <td><?php echo $data['kd_pro1']; ?></td>
                                                <td><?php echo number_format($data['totalHPProduksi'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                            </tr>
                                    <?php 
                                         }
                                        }
                    ...
                    <button onClick="print()" class="btn btn-primary pull-right">CETAK</button>
