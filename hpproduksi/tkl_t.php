	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Daftar Tenaga Kerja Langsung</h3></center>
				<?php  
                    $sql_cek="select * from  tkl ORDER BY kd_tkl ASC";
                ...
                ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['nm_tkl']; ?></td>
                                                <td><?php echo number_format($data['jmlkerja'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                            </tr>
                                    <?php 
                                         }
                                        }
                        ...
                        <a href="bop_i.php"><button type="submit" class="btn btn-primary pull-right">NEXT</button></a>
