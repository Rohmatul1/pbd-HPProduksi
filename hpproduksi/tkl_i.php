	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Input Tenaga Kerja Langsung</h3></center>
					<form  action="tkl_i_res.php" method="post">
					<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Kode TKL</label>
								<input type="text" class="form-control"  name="kd_tkl" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Nama TKL</label>
								<input type="text" class="form-control"  name="nm_tkl" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
						...
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Upah Per Jam</label>
								<input type="number" class="form-control"  name="upahperjam" required>
							</div>
						</div>
