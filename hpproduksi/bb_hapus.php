	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Hapus Bahan Baku</h3></center>
					<form  action="bb_i_res.php" method="post">
						<?php
							$kd_bb = $_GET['kd_bb'] ;
							include "koneksi.php" ;
							$sql = "select * from bb where kd_bb = '$kd_bb' ";
							...
							$qty = $data['qty'];
							echo "<center>";
							echo "Kode Bahan Baku: ".$kd_bb."<br/><br/>" ;
							echo "Nama Bahan Baku : ".$nm_bb."<br/><br/>" ;
							echo "Satuan : ".$satuan."<br/><br/>" ;
							echo "Harga Satuan: ".$hrg_satuan."<br/><br/>" ;
							echo "Quantity: ".$qty."<br/><br/>" ;
							echo "<button><a href='bb_hapus.php?kd_bb=$kd_bb&hapus=BB001'> DELETE </button></a>";
							echo "&nbsp;&nbsp;" ;
							echo "<button><a href='bb_t.php'> CANCEL </button></a> <br/><br/></center>" ;
							echo "</center>";
							if (isset($_GET['hapus'])) {
								$sql = "delete from bb where kd_bb = '$kd_bb'";
								$hasil = mysqli_query($koneksidb,$sql);
								if (!$hasil){
									echo "Gagal Hapus Bahan Baku : $nm_bb ....<br/> ";
									echo "<a href='bb_t.php'>Kembali ke Tampilan Bahan Baku</a>";
								} else {
