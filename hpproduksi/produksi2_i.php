	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Harga Pokok Produksi</h3></center>
					<form  action="produksi2_i_res.php" method="post">
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Kode HPP</label> 
								<input type="text" class="form-control" name="kd_pro2" >
								<br/>
								<label class="control-label">Kode Biaya Produksi &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp: <select name="kd_pro1" ></label>
												<?php
													include "koneksi.php";
													$sql = "select * from produksi1";
													$res = mysqli_query($koneksidb, $sql) or die("Gagal Query");
													while($r = mysqli_fetch_assoc($res)){
													echo "<option value='{$r['kd_pro1']}'>{$r['kd_pro1']}</option>";
													}
												?>
										</select>
									</br>
									</br>
									<label class="control-label">Total Biaya Produksi &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp: <select name="totalBP" ></label>
												<?php
													include "koneksi.php";
													$sql = "select * from produksi1";
													$res = mysqli_query($koneksidb, $sql) or die("Gagal Query");
													while($r = mysqli_fetch_assoc($res)){
													echo "<option value='{$r['totalBP']}'>{$r['totalBP']}</option>";
													}
												?>
										</select>
									</br>
									</br>
								<label class="control-label">Saldo Awal PDP</label> 
								<input type="text" class="form-control" name="saldoawalPDP" >
								<label class="control-label">Saldo Akhir PDP</label> 
								<input type="text" class="form-control" name="saldoakhirPDP" >
									</br>
