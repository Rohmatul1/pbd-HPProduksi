	...
	<div class="container">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="produk_t.php">Daftar Biaya Overhead Pabrik</a></li>
									<li><a href="bop_t.php">Daftar Produk</a></li>
								</ul>
							</li>
							<li class="dropdown">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Daftar Bahan Baku</h3></center>
				<?php  
                    $sql_cek="select * from  bb";
                ...
                ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data['nm_bb']; ?></td>
                                                <td><?php echo number_format($data['jml'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                                <td><?php 
													echo "<button><a href ='bb_hapus.php?kd_bb=" . $data['kd_bb'] . "'> HAPUS  &nbsp  </button></a>  ";
													echo "<button><a href ='bb_edit.php?kd_bb=" . $data['kd_bb'] . "'> EDIT </button></a> ";
												?></td>
                                            </tr>
                                    <?php 
                                         }
                        ...
                        <a href="tkl_i.php"><button type="submit" class="btn btn-primary pull-right">NEXT</button></a>
