	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<h3 style="text-align: justify">Harga pokok produksi adalah jumlah dari pada produksi yang melekat pada produksi yang dihasilkan yaitu meliputi biaya-biaya yang dikeluarkan mulai pada saat pengadaan bahan baku tersebut 
					sampai dengan proses akhir produk, yang siap untuk digunakan atau dijual. Biaya-biaya yang dimaksud ini, biaya bahan baku langsung, biaya tenaga kerja langsung dan biaya overead. 
					Selain itu dari definisi tersebut adalah dapat diketahui bahwa harga pokok produksi adalah nilai dari pengorbanan yang dilakukan dalam hubungannya dengan proses produksi berdasarkan 
					nilai ganti pada saat pertukaran.</h3>
				</div>
			</div>
			<div class="container">
				<div id="footer">
