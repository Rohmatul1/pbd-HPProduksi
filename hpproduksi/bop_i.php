	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Input Biaya Overhead Pabrik</h3></center>
					<form  action="bop_i_res.php" method="post">
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Kode BOP</label>
								<input type="text" class="form-control" name="kd_bop" >
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Taksiran BOP</label>
								<input type="number" class="form-control"  name="taksiran_bop" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group label-floating">
								<label class="control-label">Taksiran Jam TKL</label>
								<input type="number" class="form-control"  name="taksiran_jtkl" required>
							</div>
						</div>
