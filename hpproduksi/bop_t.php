	...
	<div class="container">
			...
			<div class="container">
				<div id="main-content" class="col-sm-8">
					<center><h3>Daftar Biaya Overhead Pabrik</h3></center>
				<?php  
                    $sql_cek="select * from  bop";
                ...
                ?>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><?php echo number_format($data['tarif_bop_jtkl'], $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan); ?></td>
                                            </tr>
                                    <?php 
                                         }
                                        }
                            ...
                            <a href="produksi1.php"><button type="submit" class="btn btn-primary pull-right">NEXT</button></a>
